...
public class ReportGenerator : IReportGenerator<Cita>
{
   ...
   private string GenerateHtmlContent(Cita item)
{
    return $@"
        ...
        public Result<string, DomainError> ExportHtml(Cita item)
        {
            ...
            {
                return Result.Failure<string, DomainError>(new ReportError.ReportHtmlError(ex.Message));
            }
        ...
        public Result<string, DomainError> ExportPdf(Cita item)
        {
            ...
            {
                return Result.Failure<string, DomainError>(new ReportError.ReportPdfError(ex.Message));
            }
            return Result.Success<string, DomainError>(path);
        }
}