...
public class RepositorioEnMemoria : IRepositorioVehiculos
{
    private readonly ILogger _logger = Log.ForContext<RepositorioEnMemoria>();
    ...
    {
        return _vehiculos.ContainsKey(key);
    }
